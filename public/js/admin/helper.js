...
function fetch_data(
    ...
    const urlRequest = "admin/" + url + "/fetch/data?page=" + page;
    const method = GET;
...
function pagination(view, obj, url, element, list, callback) {
    ...
    fetch_data(view, url, page, sort, column, paginate, list, callback);
}
...
function destroy(url, id, name, callbackDestroy) {
